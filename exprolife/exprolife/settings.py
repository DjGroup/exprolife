# Django settings for exprolife project.
...
SECRET_KEY = 'm@trqk73@7-g7#w-176o=-4&55s^8=18d9*w-u92^6!y++#%7k'
...
ROOT_URLCONF = 'exprolife.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'exprolife.wsgi.application'
